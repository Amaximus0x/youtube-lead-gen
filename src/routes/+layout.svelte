					...
					{:else if auth.user}
						...
						<div class="relative">
							...
							<button
								...
								class="absolute right-0 mt-2 px-4 py-2 text-sm text-gray-700 bg-white border border-gray-200 rounded-lg shadow-lg hover:bg-gray-50 transition whitespace-nowrap"
							>
								Sign Out
							</button>
						</div>
