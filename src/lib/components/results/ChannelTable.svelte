    ...
    <div class="overflow-x-auto bg-gray-50">
      <table class="min-w-full table-fixed">
        <thead>
          <tr>
            <th
              class="px-4 py-3 text-xs font-medium tracking-wider text-left text-gray-500 uppercase w-[280px]"
            >
              Channel
            </th>
            <th
              class="px-3 py-3 text-xs font-medium tracking-wider text-left text-gray-500 uppercase w-[120px]"
            >
              Subscribers
            </th>
            <th
              class="px-3 py-3 text-xs font-medium tracking-wider text-left text-gray-500 uppercase w-[100px]"
            >
              Videos
            </th>
            <th
            ...
            <th
              class="px-3 py-3 text-xs font-medium tracking-wider text-left text-gray-500 uppercase w-[140px]"
            >
              Relevance
            </th>
            <th
              class="px-3 py-3 text-xs font-medium tracking-wider text-left text-gray-500 uppercase w-[180px]"
            >
              Email Status
            </th>
            <th
                  ...
                  {#each channel.emails as email}
                    ...
                    >
                      ...
                      <button
                        ...
                        class="flex-shrink-0 text-green-700 hover:text-green-900 transition-colors"
                        title="Copy email"
                      >
                        <svg
                          class="w-3.5 h-3.5"
            ...
            <td colspan="8" class="px-4 py-6 bg-blue-50">
              <div class="flex flex-col items-center gap-3">
                ...
                <div class="text-center">
                  <p class="text-sm font-medium text-blue-700">Enriching more channels...</p>
                  {#if stats}
                    <p class="text-xs text-blue-600 mt-1">
                      {stats.passing}/{stats.target} channels found • {stats.enriched} processed
                    </p>
                  {/if}
                </div>
              </div>
